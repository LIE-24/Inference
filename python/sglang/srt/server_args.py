...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        # Additional server arguments for p2p
        parser.add_argument(
            "--initial-peers", 
            nargs="+", 
            default=[],
        ...
        parser.add_argument(
            ...
            type=str, 
            default="gradient",
            help="DHT prefix to distinguish different model networks"
        )
        
        parser.add_argument(
            "--host-maddrs",
            nargs="+",
            help="List of host addresses to listen on"
        )
        ...
        parser.add_argument(
            ...
            nargs="+",
            default=[],
            help="List of multiaddrs to announce"
        )
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="url for notify token decoding start and end"
        )
...
class PortArgs:
    ...
    recv_peer_ipc_name: str
    send_peer_ipc_name: str
    ...
    def init_new(server_args, dp_rank: Optional[int] = None) -> "PortArgs":
        ...
        if not server_args.enable_dp_attention:
            ...
            return PortArgs(
                ...
                recv_peer_ipc_name=f"ipc://{tempfile.NamedTemporaryFile(delete=False).name}",
                send_peer_ipc_name=f"ipc://{tempfile.NamedTemporaryFile(delete=False).name}",
            )
        else:
