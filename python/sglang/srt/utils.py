...
def configure_logger(server_args, prefix: str = ""):
    ...
    logging.addLevelName(logging.DEBUG, f'\033[36m{logging.getLevelName(logging.DEBUG)}\033[0m')
    logging.addLevelName(logging.INFO, f'\033[32m{logging.getLevelName(logging.INFO)}\033[0m')
    logging.addLevelName(logging.WARNING, f'\033[33m{logging.getLevelName(logging.WARNING)}\033[0m')
    logging.addLevelName(logging.ERROR, f'\033[31m{logging.getLevelName(logging.ERROR)}\033[0m')
    logging.addLevelName(logging.CRITICAL, f'\033[91m{logging.getLevelName(logging.CRITICAL)}\033[0m')
    
    format = f"[%(asctime)s.%(msecs)03d{prefix}][%(filename)s:%(lineno)d] [%(levelname)s] %(message)s"
    logging.basicConfig(
